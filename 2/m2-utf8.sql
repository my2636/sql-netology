...
select customer_id, email, substring(email, 1, (character_length(email) - character_length(substring(email, strpos(email, '@'))))) as "Email before @",
substring(email, strpos(email, '@') +1) as "Email after @"
from customer
...
concat(
upper(left(substring(email, 1, (character_length(email) - character_length(substring(email, strpos(email, '@'))))), 1)),
lower(substring(substring(email, 1, (character_length(email) - character_length(substring(email, strpos(email, '@'))))), 2))
) as "Email before @",
concat(
upper(left(substring(email, strpos(email, '@') +1), 1)),
lower(substring(substring(email, strpos(email, '@') +1), 2))
) as "Email after @"
from customer
