...
---В задании 1.2 должна быть сквозная нумерация, а не получение одинаковых рангов по общим знаменателям.---
...
----В 1 дополнительном не должно быть избыточности в результате.----
--ЗАДАНИЕ №1
...
---В 3 дополнительном необоснованное использование оконных функций там, где должна быть агрегация.----
--ЗАДАНИЕ №3
